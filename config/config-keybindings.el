...
...9"
  ...
  ("1" (aw-switch-window 0))
  ("C-c 1" (aw-switch-window 0))
  ("2" (aw-switch-window 1))
  ("C-c 2" (aw-switch-window 1))
  ("3" (aw-switch-window 2))
  ("C-c 3" (aw-switch-window 2))
  ("4" (aw-switch-window 3))
  ("C-c 4" (aw-switch-window 3))
  ("5" (aw-switch-window 4))
  ("C-c 5" (aw-switch-window 4))
  ("6" (aw-switch-window 5))
  ("C-c 6" (aw-switch-window 5))
  ("7" (aw-switch-window 6))
  ("C-c 7" (aw-switch-window 6))
  ("8" (aw-switch-window 7))
  ("C-c 8" (aw-switch-window 7))
  ("9" (aw-switch-window 8))
  ("C-c 9" (aw-switch-window 8))
  ("p" windmove-up)
  ("n" windmove-down)
  ("f" windmove-right)
  ("b" windmove-left)
...
(bind-keys*
 ...
 ("1" . hydra-windows/lambda-1)
 ("2" . hydra-windows/lambda-2)
 ("3" . hydra-windows/lambda-3)
 ("4" . hydra-windows/lambda-4)
 ("5" . hydra-windows/lambda-5)
 ("6" . hydra-windows/lambda-6)
 ("7" . hydra-windows/lambda-7)
 ("8" . hydra-windows/lambda-8)
 ("9" . hydra-windows/lambda-9)
 ;; User maps
 ("&" . hydra-shell/body)
