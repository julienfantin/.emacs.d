...
(let ((fd-blue "#49B6FC")
  ...
  (custom-theme-set-faces
   ...
   '(hydra-face-red ((t (:foreground "#c0392b" :weight bold))))
   `(hydra-face-blue ((t (:foreground ,fd-blue :weight bold))))
   '(hydra-face-teal ((t (:foreground "#2980b9" :weight bold))))
   '(hydra-face-pink ((t (:foreground "pink" :weight bold))))
   `(avy-lead-face ((t (:background nil :foreground ,fd-yellow :weight normal))))
   `(avy-lead-face-0 ((t (:background nil :foreground ,fd-yellow :weight normal))))
   ...
   '(diff-added ((t (:foreground "#29b962" ))))
   ...
   '(diff-hl-insert ((t (:background "#7f7f7f" :foreground "##7f7f7f"))))
   ...
   '(region ((t (:weight normal :underline nil :background "#3f3f3f"))))
   ...
   '(trailing-whitespace ((t (:background "#7f7f7f" :underline nil :weight normal))))
   ...
   '(font-lock-comment-face ((t (:foreground "#7f7f7f" :background "#262626":underline nil :weight normal))))
   `(font-lock-constant-face ((t (:foreground "#fff" :underline nil :weight normal))))
   '(font-lock-doc-face ((t (:weight normal :underline nil :foreground "#fff" :background "#262626" :inherit nil))))
   `(font-lock-function-name-face ((t (:foreground ,fd-blue :underline nil :weight normal))))
   `(font-lock-keyword-face ((t (:foreground "#7f7f7f" :underline nil :weight bold))))
   ...
   '(font-lock-string-face ((t (:foreground "#ddd" :background "#2e2e2e" :underline nil :weight normal))))
   ...
   '(header-line ((t (:weight normal :underline nil :foreground "#ddd" :background "#2f2f2f" :inherit mode-line))))
   ...
   `(mode-line          ((t (:weight normal :underline nil :box nil :foreground "#dfdfdf" :background ,fd-blue))))
   '(mode-line-inactive ((t (:weight normal :underline nil :box nil :foreground "#dfdfdf" :background  "#555" :inherit (mode-line)))))
   '(mode-line-buffer-id ((t (:weight normal :foreground "#191919"))))
   '(mode-line-emphasis ((t (:weight normal :underline nil))))
   '(mode-line-highlight ((t (:weight normal :underline nil :box nil))))
   '(isearch ((t (:weight normal :underline nil :foreground "#dfdfdf" :background "#b92980"))))
   '(isearch-fail ((t (:weight normal :underline nil :foreground "#ddd" :background "#858585"))))
   '(lazy-highlight ((t (:weight normal :underline nil :foreground "#b92980" :background "#22"))))

   `(powerline-active1 ((t (:background ,fd-blue))))
   `(powerline-active2 ((t (:background "#2f2f2f"))))
   `(powerline-inactive1 ((t (:background "#555"))))
   `(powerline-inactive2 ((t (:background "#2f2f2f"))))
   ...
   `(magit-section-heading ((t (:foreground  ,fd-blue :background "#292929"))))
   ...
   '(erb-comment-face ((t (:inherit erb-face :foreground "#7f7f7f" :background "#393939"))))
   ...
   '(js2-jsdoc-type ((t (:foreground "#7f7f7f"))))
   '(js2-jsdoc-value ((t (:foreground "#7f7f7f"))))
   ...
   '(erc-timestamp-face ((t (:foreground "#7f7f7f"))))
   '(erc-underline-face ((t (:underline t))))

   '(org-level-8 ((t (:foreground "#efefef"))))
   '(org-level-7 ((t (:foreground "#dfdfdf"))))
   '(org-level-6 ((t (:foreground "#ddd"))))
   '(org-level-5 ((t (:height 0.9 :foreground "#cfcfcf"))))
   '(org-level-4 ((t (:height 1.0 :foreground "#bfbfbf"))))
   '(org-level-3 ((t (:height 1.0 :foreground "#afafaf"))))
   '(org-level-2 ((t (:height 1.0 :foreground "#9f9f9f"))))
   ...
   '(w3m-lnum ((t (:foreground "#7f7f7f"))))
   '(w3m-lnum-match ((t (:background "#a5a5a5" :foreground "#393939"))))
   '(w3m-lnum-minibuffer-prompt ((t (:foreground "#ddd"))))

   `(company-preview ((t (:foreground "#eee" :background "#292929"))))
   `(company-preview-common ((t (:foreground "#eee" :background "#292929"))))
   `(company-tooltip ((t (:foreground "#ddd" :background "#292929"))))
   `(company-tooltip-common ((t (:foreground "#555" :background "#292929"))))
   `(company-tooltip-selection ((t (:foreground ,fd-blue :background "#262626" ))))
   `(company-tooltip-common-selection ((t (:foreground ,fd-blue :background "#262626"))))
   `(company-scrollbar-fg ((t (:background "#262626"))))
   `(company-scrollbar-bg ((t (:background "#393939"))))

   `(helm-source-header ((t (:background "#262626" :foreground "#ddd"  :box nil))))
   `(helm-match ((t (:foreground ,fd-blue))))
   `(helm-selection ((t (:background "#393939"  :boxh nil))))
   `(helm-ff-directory ((t (:foreground ,fd-blue :background "#292929"))))
   `(helm-ff-file ((t (:foreground "#ddd" :background "#292929"))))
   `(helm-buffer-size ((t (:foreground "#7f7f7f"))))
   `(helm-buffer-directory ((t (:foreground "#7f7f7f"))))
