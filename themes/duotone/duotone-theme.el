      ...
      (let* ((bg-fade  (chroma-fade bg fade))
        ...
        (theme-custom-set-faces
         ...
         `(;;
           ...
           (ahs-face                                   ((t (:f ,bg :b ,duo-2))))
           (ahs-definition-face                        ((t (:fg ,bg :bg ,uno-1))))
           (ahs-plugin-bod-face                        ((t (:fg ,bg :bg ,uno-2))))
           (ahs-plugin-whole-buffer-face               ((t (:fg ,bg :bg ,duo-2))))
           (ahs-edit-mode-face                         ((t (:fg ,bg :bg ,removed))))
