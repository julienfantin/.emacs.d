...
Remap all faces when called with a prefix argument."
  (interactive "P")
  (duotone--set-palette (symbol-value (intern (completing-read "Palette:" duotone-palette-default-palettes)))))
...
(defun duotone-theme-apply (theme palette)
     ...
     `(;;
       ...
       ,@(duotone-hierarchical-chroma-mapping
          ...
          (append
           ...
           (theme-faces-match-all "avy-lead")))
       ;;
       ;; Face groups
       ;;
       ;; Links
       (,(theme-faces-match '("link" "visited")) ((t (:f ,duo-2 :box nil :underline t))))
       (,(theme-faces-match-all "link" "visited") ((t (:f ,duo-3 :box nil :underline t))))
       ;;
       ;; Gui
       (,(theme-faces-match "button") ((t (:f ,uno-3 :b ,bg :box nil :underline t))))
       ;;
       ;; Colors
       (,(theme-faces-match "black") ((t (:f ,fg))))
       (,(theme-faces-match "blue") ((t (:f ,duo-2))))
       (,(theme-faces-match "cyan") ((t (:f ,duo-3))))
       (,(theme-faces-match "green") ((t (:f ,duo-1))))
       (,(theme-faces-match "magenta" "pink" "purple") ((t (:f ,uno-3))))
       (,(theme-faces-match "red" "maroon") ((t (:f ,uno-1))))
       (,(theme-faces-match "white" "silver") ((t (:f ,uno-4))))
       (,(theme-faces-match "yellow" "orange") ((t (:f ,uno-2))))
       ;;
       ...
       (,(theme-faces-match "warning") ((t (:f ,renamed :underline `(:style line :color ,(chroma-blend bg renamed sblend))))))
       ...
       ;;
       ;; Occurrences
       (,(theme-faces-match-all "occur") ((t (:f nil :b ,duo-1))))
       ((lazy-highlight secondary-selection) ((t (:f ,bg :b ,uno-2))))
       ((isearch) ((t (:f ,bg :b ,duo-1))))
       (,(theme-faces-match "occur") ((t (:b ,bg-fade))))
       ;;
       ;; Selection
       (,(cl-concatenate
          'list
       ...
       ;; Todos
       ;;
       (,(theme-faces-match "todo") ((t (:f ,duo-1 :b nil :w bold))))
       (,(theme-faces-match "done") ((t (:f ,uno-4 :w bold))))
       (,(theme-faces-match "quote" "verbatim") ((t (:f ,uno-1))))
       ...
       (,(cl-concatenate
          'list
          (theme-faces-match '(("match" "paren") "\\(mis\\|un\\)match"  "[0-9]"))
       ...
       (fringe                                     ((t (:f ,fg :b ,bg))))
       (show-paren-match  ((t (:f nil :b ,(chroma-blend bg duo-2 sblend)))))
       (show-paren-match-expression  ((t (:f nil :b ,(chroma-blend bg duo-1 sblend)))))
       (cursor                                     ((t (:f ,accent :b ,duo-1))))
       (region                                     ((t (:b ,duo-1-mfade))))
       ...
       (iedit-read-only-occurrence                 ((t (:f ,bg :b ,fg))))
       (iedit-occurrence                           ((t (:f ,bg :b ,fg))))
       ...
       (pulse-eval-face                            ((t (:f ,bg :b ,duo-1))))))))
...
;;;###autoload
(duotone-theme-apply 'duotone duotone-default-palette)

(defmacro duotone-deftheme (theme palette)
  `(progn
     (deftheme ,theme)
     `(progn
        ,@(duotone-theme-apply ',theme ,palette))))

;; (defmacro duotone-deftheme (theme palette)
;;   `(progn
;;      (deftheme ,theme)
;;      (duotone-theme-apply ',theme ,palette)))
(disable-theme 'duotone-space-dark)
(load-theme 'duotone-space-dark)
(provide 'duotone)
